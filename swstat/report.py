...
def report_detailed_stats(stats, output_format, raw_output, path=None):
    o_order = ('email', 'account_name', 'account_id', 'account_size',
...
def report_global_stats(stats, output_format, raw_output, path=None):
